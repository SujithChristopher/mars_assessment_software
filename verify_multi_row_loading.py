...
def test_multi_row_loading():
    ...
    header = ["datetime", "plane_angle", "movement_type", "patient_id", "time_point", "trial_number", 
              "ml_range_cm", "ap_range_cm", "top_y", "top_z", "bottom_y", "bottom_z", "left_y", "left_z", "right_y", "right_z"]
    
    # Trial 1: (0, 0.4), (0, 0), (-0.2, 0.2), (0.2, 0.2) -> ML Range: 0.4, AP Range: 0.4
    t1 = [now_iso, "-90.0", "MLAP", "test_id", "A0", "Trial 1", "40.0", "40.0", "0.0", "0.4", "0.0", "0.0", "-0.2", "0.2", "0.2", "0.2"]
    # Trial 2: (0, 0.5), (0, 0.1), (-0.3, 0.3), (0.3, 0.3) -> ML Range: 0.6, AP Range: 0.4
    t2 = [now_iso, "-90.0", "MLAP", "test_id", "A0", "Trial 2", "60.0", "40.0", "0.0", "0.5", "0.0", "0.1", "-0.3", "0.3", "0.3", "0.3"]
    # Average: (0, 0.45), (0, 0.05), (-0.25, 0.25), (0.25, 0.25) -> ML Range: 0.5, AP Range: 0.4
    avg = [now_iso, "-90.0", "MLAP", "test_id", "A0", "AVERAGE", "50.0", "40.0", "0.0", "0.45", "0.0", "0.05", "-0.25", "0.25", "0.25", "0.25"]
    ...
    print(f"Average ML Range: {arom.average_ml_range_cm}")
    if abs(arom.average_ml_range_cm - 50.0) > 0.01:
        print(f"FAILED: Expected average ML range 50.0, got {arom.average_ml_range_cm}")
    else:
